...
const metricsEn = [
  ...
  {
    value: "Watch",
    label: "Remote device and environmental-parameter monitoring",
  },
...
const metricsSl = [
  ...
  {
    value: "Nadziraj",
    label: "Daljinski nadzor naprav in okoljskih parametrov",
  },
  { value: "Alarmiraj", label: "Alarmna pravila in obvestila o dogodkih" },
  {
    value: "Poveži",
    label: "Poročila, API-ji in integracije s poslovnimi sistemi",
  },
];
...
const caseStudiesEn: CaseStudy[] = [
  {
    ...
    challenge:
      "The utility needed reliable remote gas meter readings for operational and billing processes.",
    solution:
      "KUEM connected gas meters through NB-IoT and prepared the data for supervision and integration workflows.",
    deployment: "Approximately 1000 gas meters via NB-IoT.",
    results: [
      "Remote reading",
      "Meter-data supervision",
      "Integration-ready field data",
    ],
  },
  {
    ...
    challenge:
      "The operator needed a LoRaWAN foundation for water metering and additional infrastructure monitoring use cases.",
    solution:
      "KUEM implemented a LoRaWAN network for water meters, Flovac vacuum shaft monitoring and a public-lighting pilot.",
    deployment:
    ...
    results: [
      ...
      "Public-lighting monitoring pilot",
    ],
  },
  {
    ...
    challenge:
      "Retail food areas needed temperature visibility across cold and heated zones.",
    solution:
      "KUEM prepared monitoring for refrigerators, freezers, salad bars and heated food areas.",
    deployment:
      "Temperature monitoring in refrigerators, freezers, salad bars and heated food areas.",
    results: [
...
const caseStudiesSl: CaseStudy[] = [
  {
    ...
    challenge:
      "Komunalni operater je potreboval zanesljivo daljinsko odčitavanje plinomerov za operativne in obračunske procese.",
    solution:
      "KUEM je plinomere povezal prek NB-IoT in pripravil podatke za nadzor ter integracijske procese.",
    deployment: "Približno 1000 plinomerov prek NB-IoT.",
    results: [
      "Daljinsko odčitavanje",
      "Nadzor merilnih podatkov",
      "Terenski podatki, pripravljeni za integracije",
    ],
  },
  {
    title: "JKP Brezovica d.o.o.",
    ...
    challenge:
      "Operater je potreboval LoRaWAN osnovo za merjenje vode in dodatne primere nadzora infrastrukture.",
    solution:
      "KUEM je implementiral LoRaWAN omrežje za vodomere, nadzor Flovac vakuumskih jaškov in pilot javne razsvetljave.",
    deployment:
    ...
    results: [
      ...
      "Pilot nadzora javne razsvetljave",
    ],
  },
  {
    title: "Tropic Maloprodaja d.o.o.",
    ...
    challenge:
      "Maloprodajna območja s hrano so potrebovala pregled nad temperaturami v hladnih in ogrevanih conah.",
    solution:
      "KUEM je pripravil spremljanje temperature v hladilnikih, zamrzovalnikih, solatnih barih in ogrevanih območjih s hrano.",
    deployment:
      "Spremljanje temperature v hladilnikih, zamrzovalnikih, solatnih barih in ogrevanih območjih s hrano.",
    results: [
      "Nadzor temperature",
      "Podatki za alarmiranje",
