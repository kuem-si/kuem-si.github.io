...
export const explorerBenefitsEn = [
  {
    ...
    text: "All important data in one place.",
    step: 3,
  },
  {
    icon: "bell",
    title: "Timely alerts",
    text: "See important changes in time.",
    step: 4,
  },
  {
    icon: "chart",
    title: "A basis for better decisions",
    text: "Reliable data for more effective action.",
    step: 3,
  },
];
export const explorerExamplesEn = [
  {
    ...
    text: "The responsible person sees the deviation before it becomes a larger problem.",
    step: 4,
  },
  {
    icon: "energy",
    title: "Energy deviation",
    text: "Consumption comparison over time highlights an unusual change.",
    step: 3,
  },
  {
    icon: "bike",
    title: "Mobility planning",
    text: "Data from several sources identifies the routes that are actually under load.",
    step: 2,
  },
];
...
const englishSteps = [
  {
    ...
    next: "Connectivity",
    title: "Data begins in the field.",
    description:
      "We connect sensors, meters and existing field equipment and ensure reliable data acquisition.",
    heading: "What we provide",
    items: [
      [
        "Selecting suitable devices",
        "We advise on and select devices suited to your needs and environment.",
      ],
      [
        "Including existing equipment",
        "We connect and integrate existing meters, sensors and field equipment.",
      ],
      [
        "Configuration and measurement validation",
        "We configure devices, verify operation and ensure reliable data.",
      ],
    ],
    tagLabel: "Suitable for",
    tags: ["Water and gas", "Energy", "Environment", "Infrastructure"],
  },
  {
    name: "Connectivity",
    next: "Integrations",
    title: "We choose the right data path for every location.",
    description:
      "We do not advocate one technology for every case. We choose connectivity based on location, range, energy use and data volume.",
    heading: "What we provide",
    items: [
      [
        "Coverage planning",
        "We assess the location, environment and use requirements.",
      ],
      [
        "Installation and configuration",
        "We ensure the communication infrastructure is implemented correctly.",
      ],
      [
        "Connection-quality monitoring",
        "We monitor performance and detect deviations in time.",
      ],
    ],
    tagLabel: "Supported paths",
    tags: ["LoRaWAN", "NB-IoT", "wM-Bus", "LAN"],
  },
  {
    name: "Integrations",
    next: "Nexavia",
    title: "Existing systems remain. We connect the data.",
    description:
      "Nexavia connects to solutions you already use through standard interfaces. We avoid unnecessary data duplication and do not require replacement of working infrastructure.",
    heading: "What we can connect",
    items: [
      ["Business systems", "ERP, billing and other dedicated solutions."],
      ["Operational systems", "SCADA, monitoring systems and device data."],
      [
        "Spatial and external sources",
        "GIS, open data, weather and other platforms.",
      ],
    ],
    tagLabel: "Supported paths",
    tags: ["API", "ERP", "SCADA", "GIS"],
  },
  {
    name: "Nexavia + KAI",
    next: "Decision",
    title: "We turn data into a useful overview.",
    description:
      "Nexavia combines different sources in one place. KAI analyzes the data, flags deviations and helps the responsible person understand where action is needed.",
    heading: "What the user gets",
    items: [
      ["Unified overview", "Key data in one place."],
      ["Timely alerts", "See deviations before they become a larger problem."],
      ["Decision support", "KAI highlights what requires attention."],
    ],
    note: "KAI is the analytics assistant within Nexavia.",
  },
  {
    ...
    description:
      "Responsible users receive a clear alert, context and a proposed next step. A person can confirm the action, or automation can carry it out under agreed rules.",
    heading: "Examples of actions",
    items: [
      ["Work order", "The fault is sent to maintenance."],
      ["Operating adjustment", "A setting changes after confirmation."],
      ["Management report", "The decision is based on traceable data."],
    ],
    note: "People remain in control of decisions.",
  },
  {
    name: "NOC and managed services",
    title: "We continue monitoring solutions after implementation.",
    description:
      "Continuous monitoring, response, maintenance and expert support keep the entire solution reliable over the long term.",
    heading: "What we monitor",
    items: [
      ["Devices", "Availability and measurement validity."],
      ["Connectivity", "Communication-path quality."],
      ["Alerts", "Deviation handling and notifications."],
      ["Support", "Maintenance and user assistance."],
    ],
    note: "One partner for the operation of the entire solution.",
  },
] as const;

export const solutionStepsEn: SolutionStep[] = solutionSteps.map(
  (step, index) => {
    ...
    return {
      ...
      items: step.items.map((item, itemIndex) => ({
        ...item,
        title: copy.items[itemIndex][0],
        text: copy.items[itemIndex][1],
      })),
