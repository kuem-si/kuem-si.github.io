...
const equivalentPairs: Record<string, Record<Locale, string>> = {
  "/": { en: "/en", sl: "/" },
  "/solutions": { en: "/en/solutions", sl: "/resitve" },
  "/resitve": { en: "/en/solutions", sl: "/resitve" },
  "/utilities": { en: "/en/solutions", sl: "/resitve" },
  "/platform/nexavia": {
  ...
  "/contact": { en: "/en/contact", sl: "/kontakt" },
  "/kontakt": { en: "/en/contact", sl: "/kontakt" },
  "/about": { en: "/en/company", sl: "/o-nas" },
  "/o-nas": { en: "/en/company", sl: "/o-nas" },
  "/references": { en: "/en/references", sl: "/reference" },
  "/reference": { en: "/en/references", sl: "/reference" },
  "/case-studies": { en: "/en/references", sl: "/reference" },
